...
<footer class="main-footer" @if($bgImage) style="background-image: url('{{ $bgImage }}'); background-size: cover; background-position: center; background-repeat: no-repeat;" @endif>
    <div class="footer-container">
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                ...
                <p>
                    {{ $settings->footer_description ?? $settings->footer_text ?? 'Founded on the principles of preserving traditional Indian handlooms, we bring you curated collections that tell a story of artisanal mastery and timeless elegance.' }}
                </p>

            ...
            <div class="bg-white p-8 rounded shadow-sm border border-[#E5E0DA] sticky top-32">
                ...
                <div class="space-y-4 mb-6">
                    <div class="flex justify-between text-sm text-gray-600 font-medium">
                        <span>Subtotal</span>
                        <span class="text-[#1b1c1a]">Rs. {{ number_format($cartDetails['subtotal']) }}</span>
                    </div>
                    <div class="flex justify-between text-sm text-gray-600 font-medium">
                        <span>Shipping</span>
                        <span class="text-[#1b1c1a]">{{ $cartDetails['shipping'] == 0 ? 'Complimentary' : 'Rs. '.number_format($cartDetails['shipping']) }}</span>
                    </div>
                </div>
                
                <div class="flex justify-between border-t border-[#E5E0DA] py-6 text-xl font-bold text-[#1b1c1a]" style="font-family: 'Noto Serif', serif;">
                    <span>Total</span>
                    <span class="text-[#800020]">Rs. {{ number_format($cartDetails['total']) }}</span>
                </div>

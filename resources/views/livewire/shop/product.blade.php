<main class="product-main">
    <div class="product-container">
        ...
        <div class="product-info">
            ...
            @if($product->stock > 0)
                <span class="stock-status text-green-600 font-bold">
                    In Stock ({{ $product->stock }} left)
                </span>
            @else
                <span class="stock-status text-red-500 font-bold">
                    (Out of stock)
                </span>
            @endif
                ...
                <div class="similar-products">
                    ...
                    <div class="similar-grid">
                        ...
                        @foreach($similarProducts as $simProduct)
                            ...
                            <a
                                href="{{ route('shop.product', $simProduct->id) }}"
                                class="sim-item block hover:opacity-80 transition-opacity"
                            >
                                <img
                                    src="{{ $simImg }}"
                                    alt="{{ $simProduct->name }}"
            ...
            <div class="purchase-controls">
                ...
                <div class="quantity-box">
                    ...
                    <div class="qty-selector flex items-center gap-4">
                        ...
                        <span id="quantity" class="font-bold">
                            {{ $quantity }}
                        </span>

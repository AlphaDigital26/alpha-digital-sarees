        ...
        @if(count($this->cartData['items']) > 0)
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                ...
                <aside class="lg:col-span-4 bg-white p-8 border border-[#E5E0DA] shadow-sm sticky top-32 rounded-sm h-fit">
                    ...
                    <button wire:click="checkout" class="w-full bg-[#800020] text-white py-4 font-bold uppercase tracking-[0.15em] text-xs hover:bg-[#570013] transition-colors shadow-md rounded-sm mb-4">
                        Proceed to Checkout
                    </button>
